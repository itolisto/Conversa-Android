    ...
    public void takeStillshot() {
        ...
        Camera.PictureCallback jpegCallback = new Camera.PictureCallback() {
            public void onPictureTaken(final byte[] data, Camera camera) {
                //Log.e(TAG, "onPictureTaken - jpeg, size: " + data.length);
                ...
                ImageUtil.saveToDiskAsync(data, outputPic, new ICallback() {
                    ...
                    public void done(Exception e) {
                        if (e == null) {
                            Log.e("CameraFragment", "Picture saved to disk - jpeg, size: " + data.length);
                            //mOutputUri = ImageUtil.getPath(getActivity(), Uri.fromFile(outputPic));
